Analyzing the codebase to document the system flow. Reviewing routes, features, and user interactions.


[3 tools called]


Reviewing template files to understand frontend interactions:
...
├── ai_apis.env                 # Environment variables (API keys)
├── adet_rentease_finals_v8.sql # Database schema
├── requirements.txt            # Python dependencies
├── README.md                   # Project documentation
├── bhouse.png                  # Placeholder image
└── templates/
